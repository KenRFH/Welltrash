            ...
            <section className="relative w-full pt-32 pb-20 lg:pt-40 lg:pb-28 bg-white overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-slate-900 mb-6">
                        Tentang{" "}
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-[#8CCE21]">
                            Well<span className="text-[#FF9A0C]">trash</span>
                        </span>
                    </h1>

                    <p className="text-lg md:text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
                        Kami adalah pelopor manajemen limbah digital di
                        Indonesia. Welltrash mengintegrasikan teknologi logistik
                        untuk memberikan solusi persampahan komersial yang
                        terjadwal, efisien, dan ramah lingkungan.
                    </p>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div className="space-y-6">
                            <h2 className="text-3xl font-bold text-slate-900">
                                Mewujudkan Ekonomi Sirkular di Jember dan
                                Sekitarnya
                            </h2>
                            <p className="text-slate-600 leading-relaxed text-lg">
                                PT Sarana Utama Welltrash Farm didirikan dengan
                                visi untuk mentransformasi cara perusahaan dan
                                fasilitas komersial mengelola limbah mereka.
                                Kami memahami bahwa manajemen sampah sering kali
                                menjadi tantangan operasional yang kompleks.
                            </p>
                            <p className="text-slate-600 leading-relaxed text-lg">
                                Dengan pendekatan End-to-End Waste Management,
                                kami memastikan bahwa setiap proses—dari
                                penjemputan hingga pemrosesan akhir—dilakukan
                                secara transparan, mudah dilacak, dan sepenuhnya
                                mematuhi regulasi lingkungan hidup (ESG) di
                                Indonesia.
                            </p>
                        </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-white rounded-3xl p-8 lg:p-10 shadow-sm border border-slate-100 relative overflow-hidden">
                            ...
                            <p className="text-slate-600 leading-relaxed text-lg">
                                Menjadi platform kolaboratif nomor satu di
                                Indonesia yang mengintegrasikan kecerdasan
                                logistik dan prinsip ekonomi sirkular untuk
                                mewujudkan lanskap industri masa depan yang
                        ...
                        <div className="bg-white rounded-3xl p-8 lg:p-10 shadow-sm border border-slate-100 relative overflow-hidden">
                            ...
                            <ul className="space-y-4 text-slate-600">
                                <li className="flex items-start gap-3">
                                    ...
                                    <span>
                                        Menyediakan solusi B2B yang hemat waktu,
                                        praktis, dan dapat diandalkan setiap
                                        harinya.
                                    </span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <span className="flex h-2 w-2 rounded-full bg-green-500 mt-2 flex-shrink-0"></span>
                                    <span>
                                        Menyajikan pelaporan data secara rutin
                                        yang kredibel untuk mendukung inisiatif
                                ...
                                <li className="flex items-start gap-3">
                                    <span className="flex h-2 w-2 rounded-full bg-green-500 mt-2 flex-shrink-0"></span>
                                    <span>
                                        Mendorong *recovery rate* sampah yang
                                        dapat didaur ulang bersama jaringan
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                            Sekilas dokumentasi aktivitas kami di lapangan,
                            menunjukkan dedikasi tim Welltrash dalam mengelola
                        ...
                        <div className="space-y-6 lg:space-y-8">
                            <div className="group relative overflow-hidden rounded-3xl aspect-[4/5] shadow-sm">
                                ...
                                <div className="absolute inset-0 flex flex-col justify-end p-8 translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                                    ...
                                    <p className="text-slate-200 text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100">
                                        Proses pengangkutan terjadwal dari
                                        fasilitas mitra komersial menuju pusat
                                        pengolahan.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="group relative overflow-hidden rounded-3xl aspect-[4/3] shadow-sm">
                                ...
                                <div className="absolute inset-0 flex flex-col justify-end p-8 translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                                    ...
                                    <p className="text-slate-200 text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100">
                                        Memberikan pendampingan tata kelola
                                        sampah kepada staf operasional mitra.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-6 lg:space-y-8 lg:translate-y-12">
                            <div className="group relative overflow-hidden rounded-3xl aspect-[4/3] shadow-sm">
                                ...
                                <div className="absolute inset-0 flex flex-col justify-end p-8 translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                                    ...
                                    <p className="text-slate-200 text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100">
                                        Pekerja terampil kami menyortir sampah
                                        anorganik sesuai jenis dan nilainya.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="group relative overflow-hidden rounded-3xl aspect-[4/5] shadow-sm">
                                ...
                                <div className="absolute inset-0 flex flex-col justify-end p-8 translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                                    ...
                                    <p className="text-slate-200 text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100">
                                        Mendistribusikan material daur ulang ke
                        ...
                        <div className="space-y-6 lg:space-y-8 lg:translate-y-24">
                            <div className="group relative overflow-hidden rounded-3xl aspect-[4/5] shadow-sm">
                                ...
                                <div className="absolute inset-0 flex flex-col justify-end p-8 translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                                    ...
                                    <p className="text-slate-200 text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100">
                                        Mengurai limbah makanan dan organik
                                        menjadi kompos bernutrisi tinggi.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="group relative overflow-hidden rounded-3xl aspect-[4/3] shadow-sm">
                                ...
                                <div className="absolute inset-0 flex flex-col justify-end p-8 translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                                    ...
                                    <p className="text-slate-200 text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100">
                                        Pencatatan volume sampah secara
                                        real-time untuk kebutuhan ESG report.
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-20 relative overflow-hidden rounded-t-[4rem]">
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
                    ...
                    <p className="text-slate-300 text-lg mb-10 max-w-2xl mx-auto">
                        Bergabunglah bersama mitra-mitra kami lainnya untuk
                        mengelola limbah dengan cara yang lebih pintar, aman,
                        dan efisien.
                    </p>
